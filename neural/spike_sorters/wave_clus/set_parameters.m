...
par.detect_fmin = 250;               % high pass filter for detection 
par.detect_fmax = 7500;              % low pass filter for detection (default 1000) 
par.detect_order = 4;                % filter order for detection. 0 to disable the filter. 
par.sort_fmin = 250;                 % high pass filter for sorting 
par.sort_fmax = 7500;                % low pass filter for sorting (default 3000) 
...
par.template_sdnum = 5;             % max radius of cluster in std devs. 
