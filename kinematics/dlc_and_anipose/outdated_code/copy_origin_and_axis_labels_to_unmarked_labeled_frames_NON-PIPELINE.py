...
nCams = 4
num_axes_labels = 3
dlc_scorer = 'AshvinKumar' #Dalton' #'AshvinKumar'
date_to_copy = '2022_12_01' #'2022_08_18' # can be a date in format '####_##_##' or None
labels_path = '/project/nicho/projects/bci/dlc_project_files/bci-AshvinKumar-2022-01-09/labeled-data'
# labels_path = '/project/nicho/projects/marmosets/dlc_project_files/full_marmoset_model-Dalton-2022-07-26/labeled-data'
