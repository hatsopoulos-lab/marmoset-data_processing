...
'''
    Steps to complete this:
        1) make a new project for 2-sided simple joints model.
        2) Copy the labeled_data folder, deleted labels
        3) Edit config files for subset of data
        4) 
'''
...
base = '/project/nicho/projects/marmosets/dlc_project_files/'

old_path = os.path.join(base, 'full_marmoset_model-Dalton-2022-07-26/labeled-data/')
new_path = os.path.join(base, 'simple_joints_model-Dalton-2021-04-08/labeled-data/')
