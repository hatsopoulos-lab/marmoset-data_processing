...
def remove_spurious_sleep_signals(eventTimes, session, chans_per_sess, allExp_signalTimes, breakTimes):       
...
def clean_remaining_spurious_sleep_signals(eventTimes, allExp_signalTimes, allExp_frameCounts, numSessions, chans_per_sess, removed_eventTimes):
...
def prepare_final_data_and_metadata(expNames, allExp_frameCounts, allExp_signalTimes, allExp_vidPaths, 
                                    eventTimes, removed_eventTimes, uniqueSessions, numSessions, chans_per_sess, kinFolders):
...
if __name__ == '__main__':
    ...
    ap.add_argument("-us", "--unique_sessions", nargs='+', required=True, type=int,
     	help="session(s) of recording (can have multiple entries separated by spaces)")
    ...
    if task_id == 0:    
        ...
        for eFold in ephys_folders:
            ...
            removed_eventTimes = []
            eventTimes, breakTimes, allExp_signalTimes, session, uniqueSessions, numSessions, chans_per_sess = remove_spurious_sleep_signals(eventTimes, session, chans_per_sess, allExp_signalTimes, breakTimes)       
            eventTimes, removed_eventTimes = clean_remaining_spurious_sleep_signals(eventTimes, allExp_signalTimes, 
            ...
            saveData = prepare_final_data_and_metadata(expNames, allExp_frameCounts, allExp_signalTimes, allExp_vidPaths, 
                                                       eventTimes, [], args['unique_sessions'], numSessions, chans_per_sess, matched_kinFolders) 
