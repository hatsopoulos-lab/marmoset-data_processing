...
base_nwb_file_pattern = '/project/nicho/data/marmosets/electrophys_data_for_processing/TY20210211_inHammock_night/TY20210211_inHammock_night-002'
phy_path = os.path.join(os.path.dirname(base_nwb_file_pattern), 'processed/phy_IC') 
...
with NWBHDF5IO(nwb_acquisition_file, 'r') as io:
    ...
    try:
        raw_start_time  = nwb.acquisition['ElectricalSeries'].starting_time
        raw_sample_rate = nwb.acquisition['ElectricalSeries'].rate
    except:
