...
if __name__ == '__main__':
    ...
    if not first_run:
        ...
        event_dict, inter_data = load_or_run_event_fragments(cam_list               = [            3,              4,             5], # FIXME
                                                             event_idx_range_list   = [range(10, 85), range(10, 102), range(10, 23)], # FIXME
                                                             correct_event_idx_list = [            9,              9,             9], # FIXME
                                                             fps                    = fps,
                                                             jpg_dir                = jpg_dir,
        ...
        event_dict, inter_data = load_or_run_change_event_nums(cam_list                     = [            3,               4,             5], # FIXME
                                                                event_idx_range_list         = [range(85, 86), range(102, 103), range(23, 24)], # FIXME
                                                                correct_event_idx_range_list = [range(10, 11), range( 10,  11), range(10, 11)], # FIXME
                                                                jpg_dir                      = jpg_dir,
                                                                all_cams_list                = all_cams_list,
                                                                key                          = key)
        ...
        key += '_fr'
        event_dict, inter_data = load_or_run_event_fragments(cam_list               = [             3,               4,             5], # FIXME
                                                              event_idx_range_list   = [range(86, 139), range(103, 155), range(24, 27)], # FIXME
                                                              correct_event_idx_list = [            10,              10,            10], # FIXME
                                                              fps                    = fps,
                                                              jpg_dir                = jpg_dir,
                                                              all_cams_list          = all_cams_list,
                                                              key                    = key) 
        ...
        key += '_ev'
        event_dict, inter_data = load_or_run_change_event_nums(cam_list                     = [              3,               4,             5], # FIXME
                                                               event_idx_range_list         = [range(139, 145), range(155, 161), range(27, 36)], # FIXME
                                                               correct_event_idx_range_list = [range( 11,  17), range( 11,  17), range(11, 20)], # FIXME
                                                               jpg_dir                      = jpg_dir,
                                                               all_cams_list                = all_cams_list,
                                                               key                          = key)
        ...
        event_dict, inter_data = load_or_run_event_fragments(cam_list               = [             3,                4], # FIXME
                                                             event_idx_range_list   = [range(145, 171), range(161, 196)], # FIXME
                                                             correct_event_idx_list = [            16,               16], # FIXME
                                                             fps                    = fps,
                                                             jpg_dir                = jpg_dir,
                                                             all_cams_list          = all_cams_list,
                                                             key                    = key)
        ...
        event_dict, inter_data = load_or_run_change_event_nums(cam_list                     = [              3,               4], # FIXME
                                                               event_idx_range_list         = [range(171, 174), range(196, 199)], # FIXME
                                                               correct_event_idx_range_list = [range( 17,  20), range( 17,  20)], # FIXME
                                                               jpg_dir                      = jpg_dir,
                                                               all_cams_list                = all_cams_list,
                                                               key                          = key)
        ...
        key += '_fr'
        event_dict, inter_data = load_or_run_event_fragments(cam_list               = [               3,               4,             5], # FIXME
                                                              event_idx_range_list   = [range(174, 210), range(199, 231), range(36, 46)], # FIXME
                                                              correct_event_idx_list = [             19,              19,            19], # FIXME
                                                              fps                    = fps,
                                                              jpg_dir                = jpg_dir,
                                                              all_cams_list          = all_cams_list,
                                                              key                    = key)
        ...
        key += '_ev'
        event_dict, inter_data = load_or_run_change_event_nums(cam_list                     = [              3,               4,             5], # FIXME
                                                               event_idx_range_list         = [range(210, 211), range(231, 232), range(46, 47)], # FIXME
                                                               correct_event_idx_range_list = [range( 20,  21), range( 20,  21), range(20, 21)], # FIXME
                                                               jpg_dir                      = jpg_dir,
                                                               all_cams_list                = all_cams_list,
                                                               key                          = key)
        ...
        key += '_fr'
        event_dict, inter_data = load_or_run_event_fragments(cam_list               = [              3,               4,              5], # FIXME
                                                             event_idx_range_list   = [range(211, 550), range(232, 585), range(47, 178)], # FIXME
                                                             correct_event_idx_list = [             20,              20,             20], # FIXME
                                                             fps                    = fps,
                                                             jpg_dir                = jpg_dir,
                                                             all_cams_list          = all_cams_list,
                                                             key                    = key)
        ...
        key += '_ev'
        event_dict, inter_data = load_or_run_change_event_nums(cam_list                     = [              3,               4,               5], # FIXME
                                                               event_idx_range_list         = [range(550, 551), range(585, 586), range(178, 179)], # FIXME
                                                               correct_event_idx_range_list = [range( 21,  22), range( 21,  22), range( 21,  22)], # FIXME
                                                               jpg_dir                      = jpg_dir,
                                                               all_cams_list                = all_cams_list,
                                                               key                          = key)
        ...
        key += '_fr'
        event_dict, inter_data = load_or_run_event_fragments(cam_list               = [               3,                4,               5], # FIXME
                                                             event_idx_range_list   = [range(551, 1668), range(586, 1673), range(179, 660)], # FIXME
                                                             correct_event_idx_list = [              21,               21,              21], # FIXME
                                                             fps                    = fps,
                                                             jpg_dir                = jpg_dir,
                                                             all_cams_list          = all_cams_list,
                                                             key                    = key)
        ...
        key += '_ev'
        event_dict, inter_data = load_or_run_change_event_nums(cam_list                     = [                3,                 4,               5], # FIXME
                                                               event_idx_range_list         = [range(1668, 1672), range(1673, 1677), range(660, 664)], # FIXME
                                                               correct_event_idx_range_list = [range(  22,   26), range(  22,   26), range( 22,  26)], # FIXME
                                                               jpg_dir                      = jpg_dir,
                                                               all_cams_list                = all_cams_list,
                                                               key                          = key)
        ...
        key += '_fr'
        event_dict, inter_data = load_or_run_event_fragments( cam_list               = [                3,                 4,               5], # FIXME
                                                              event_idx_range_list   = [range(1672, 2444), range(1677, 2461), range(664, 969)], # FIXME
                                                              correct_event_idx_list = [               25,                25,              25], # FIXME
                                                              fps                    = fps,
                                                              jpg_dir                = jpg_dir,
                                                              all_cams_list          = all_cams_list,
                                                              key                    = key)
        ...
        key += '_ev'
        event_dict, inter_data = load_or_run_change_event_nums( cam_list                     = [                3,                 4,               5], # FIXME
                                                                event_idx_range_list         = [range(2444, 2445), range(2461, 2462), range(969, 970)], # FIXME
                                                                correct_event_idx_range_list = [range(  26,   27), range(  26,   27), range( 26,  27)], # FIXME
                                                                jpg_dir                      = jpg_dir,
                                                                all_cams_list                = all_cams_list,
                                                                key                          = key)