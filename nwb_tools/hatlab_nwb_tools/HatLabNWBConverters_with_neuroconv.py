...
class MarmCheckNWBConverter(NWBConverter):
    ...
    data_interface_objects = dict(
        BlackrockRecordingInterfaceRaw=BlackrockRecordingInterface,
...
#         BlackrockRecordingInterfaceRaw=BlackrockRecordingInterface,
#         BlackrockSortingInterface=BlackrockSortingInterface,
#         ApparatusBehaviorVideos=VideoInterface,
#         ApparatusCalibrationVideos=VideoInterface,
#         EnclosureBehaviorVideos=VideoInterface,
#         EnclosureCalibrationVideos=VideoInterface,
#     )
